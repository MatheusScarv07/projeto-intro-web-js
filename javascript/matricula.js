...
if(realizarMatricula){
  ...
  const alunomatriculado=document.getElementById('funcaomatricular')
  alunomatriculado.innerHTML=`<div ><h2>Aluno Matriculado <img src="./imagem/certo.png" alt=""></h2> </div>`
